...
val movieList: List<Movie> = listOf(
    ...
    Movie(
        ...
        poster = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDFj-Q39n3AtThEnOyv56E8figbTFzHS7_KA&s"
    ),
    Movie(
        idMovie = 5,
        title = "Pulp Fiction",
    ...
    Movie(
        ...
        poster = "https://m.media-amazon.com/images/M/MV5BZGRiZDZhZjItM2M3ZC00Y2IyLTk3Y2MtMWY5YjliNDFkZTJlXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg"
    ),
    Movie(
        idMovie = 10,
        ...
        poster = "https://m.media-amazon.com/images/M/MV5BZTdlM2U4MzItYTIyYy00YTc4LTgyNjAtN2NjMzBhZmM1MDRiXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg"
    )
)